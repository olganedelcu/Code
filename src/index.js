...
r /= 2;
console.log(r);
var relyOn = "Be nice'people will thank you";
console.log(relyOn);
...
function checkObject(checkProp) {
  if (stinky.hasOwnProperty(checkProp)) {
    return stinky[checkProp];
  } else {
    return "Not Found";
  }
}
console.log(checkObject("Hello"));
console.log(checkObject("hair"));
...
console.log(recordCollection.countries["Alemania"]);

const Dylan = {
  colorhair: "brown",
  age: 18
};
Object.entries(Dylan); // keys and values
Object.keys(Dylan); // only keys => ["colorhair", "age"]
Object.values(Dylan); // only values ["brown", 18]
Object.assign(Dylan, { eaves: "none" }); // adding properties
console.log(Dylan["eaves"]);
console.log(Object.entries(Dylan));
...
console.log(books.camus);
console.log(books["camus"]);
console.log(years["1913"]);
console.log(books[years["1913"]]);

function sayByeBye(x) {
  return `See you soon, ${x}`;
}
console.log(sayByeBye("Lara"));

function sayHi(x) {
  return `Hi there, ${x}`;
}

console.log(sayHi("Miruna"));

var eveningGreeting = function() {
  // the fuction does not have a name
  return `Good evening!`;
};

var morningGreeting = function greeting() {
...
var bobSpongue = () => "Hello Bob!";
console.log(bobSpongue());

var physicsAndMaths = () => "Cool";
console.log(physicsAndMaths());

var items = ["milk", "bread", "fruits", "chocolate"];
items.map(element => console.log(element.length));
...
items.forEach(element => console.log(element.length));

var sum = (a, b) => a + b;
var multiply = (a, b) => a * b;

var calculate = (x, y, callbackFn) => callbackFn(x, y);

console.log(calculate(2, 3, sum));
console.log(calculate(7, 6, multiply));

var division = (d, c) => d / c;
var times = (f, g) => f * g;

var calculate = (x, y, callbackFn) => callbackFn(x, y);
console.log(calculate(2, 3, times));
console.log(calculate(7, 6, division));

function greetTime(time, name) {
  return `Hey, ${name} ${time}`;
}
console.log(greetTime("David", "morning"));
...
// round numbers with .toFixed and .toPrecision
